...
const starterStyle = {
  ...
  return (
    ...
    <div style={{height: "90vh",display: "flex", justifyContent: "space-evenly",alignItems:"center"}}>
              <div className={styles.transparentCard} style={{height:"20vh",width:"20vh",borderRadius:"10px",}}>
              <img style={{borderRadius: "85px"}} src={userimage}  ></img>
              </div>
                                <div  style={imgFlex} className={styles.transparentCard} >{<div> 
